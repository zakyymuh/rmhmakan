 ...
 <script type="text/javascript">
    ...
    <script src="<?=url?>assets/js/demo.js"></script>
            <script src="<?=url?>assets/js/pages/ui/modals.js"></script>
 <script src="<?=url?>assets/plugins/tinymce/tinymce.js"></script>
    <script src="<?=url?>assets/js/pages/forms/editors.js"></script>
