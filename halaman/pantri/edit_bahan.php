    ...
    <section class="content">
        <div class="container-fluid">
           <div class="row">
            ...
            <div class="body">
                <div class="row">
                    <form action="<?=url?>aksi/bahan.php?aksi=edit&id_bahan=<?=$id;?>" method="POST">
                    <div class="col-md-8">
                        <label>Nama bahan baku</label>
                <div class="form-group">
                                    <div class="form-line">
                                        <input id="email_address" class="form-control" name="nama" placeholder="Masukan nama bahan" required="required" type="text" value="<?=$nama;?>">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-2">
                            ...
                            <div class="form-group">
                                    <div class="form-line">
                                        <input id="email_address" class="form-control" placeholder="" name="satuan" required="required" type="text" value="<?=$satuan;?>">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-2">
                            ...
                            <div class="form-group">
                                    <div class="form-line">
                                        <input id="email_address" class="form-control" placeholder="" name="jumlah" required="required" type="number" disabled="" value="<?=$jumlah;?>">
                                    </div>
                                </div>
                            </div>
